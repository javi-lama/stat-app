...
const MainLayout: React.FC = () => {
    ...
    // Context State
    const { activeWard, isAuthLoading, clearActiveWard } = useAppContext();
                    ...
                    <div className="relative">
                        ...
                        {isSettingsOpen && (
                            <>
                                ...
                                />
                                <div className="absolute right-0 top-full mt-2 bg-white rounded-lg shadow-lg border border-slate-200 z-50 min-w-[200px] overflow-hidden">
                                    <button
                                        onClick={() => {
                                            clearActiveWard();
                                    ...
                                    >
                                        <span className="material-symbols-outlined text-[18px] text-slate-500">swap_horiz</span>
                                        Cambiar de Servicio
                                    </button>
                                </div>
                            </>
